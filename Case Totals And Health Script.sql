...
--Creating Up-To-Date Table For Total Cases, Vaccinations, Tests Per Country--
SELECT 
Country, 
...
DELETE FROM [COVID Project].dbo.[Clean-COVID-Data]
WHERE [Cases Per Date]='' OR [Deaths Per Date]='' OR [Tests Per Date]='' OR [Vaccinations Per Date]=''